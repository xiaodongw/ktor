pluginManagement {
    ...
    val jmh_plugin_version: String by settings
    ...
    resolutionStrategy {
        eachPlugin {
            when (requested.id.id) {
                "binary-compatibility-validator" -> useModule("org.jetbrains.kotlinx:binary-compatibility-validator:$validator_version")
                "kotlinx.benchmark" -> useModule("org.jetbrains.kotlinx:kotlinx.benchmark.gradle:$benchmarks_version")
                "kotlinx-atomicfu" -> useModule("org.jetbrains.kotlinx:atomicfu-gradle-plugin:$atomicfu_version")
                "me.champeau.gradle.jmh" -> useModule("me.champeau.gradle:jmh-gradle-plugin:$jmh_plugin_version")
            }
        }
    }
}
